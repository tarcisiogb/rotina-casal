...
function renderGraficoLinha(pontos, corLinha) {
  ...
  svg += '<text x="' + PAD + '" y="14" font-size="11" fill="var(--muted)">' + fmt1(max) + '</text>';
  svg += '<text x="' + PAD + '" y="' + (H - 10) + '" font-size="11" fill="var(--muted)">' + fmt1(min) + '</text>';
  svg += '</svg>';
  return svg;
}
