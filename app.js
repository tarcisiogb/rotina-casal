...
function campoModalHtml(campoId, tipo, valorAtual, titulo, callbackNome) {
  ...
  return '<button type="button" class="input" style="text-align:left;background:#fff;cursor:pointer;" onclick="abrirModalCampo(\'' + campoId + '\',\'' + tipo + '\',\'' + (valorAtual || '') + '\',\'' + titulo + '\',\'' + callbackNome + '\')">' + texto + '</button>';
}
