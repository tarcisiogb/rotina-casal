...
function renderPeriodosCard() {
  ...
  html += '<div class="card-sub">Para remédio ou atividade que você faz por um período (ex: antidepressivo, dieta específica)</div>';
  html += '<div class="field"><div class="quem-pick">';
  ...
  html += '<button type="button" class="tipo-pill' + pillOn('periodoTipo', 'atividade') + '" onclick="capturarCamposPeriodo();selectSingle(\'periodoTipo\',\'atividade\',this);renderSaude();">🏃 Atividade</button>';
  html += '</div></div>';
