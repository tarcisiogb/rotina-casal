...
function renderIntimidade() {
  ...
  var elDH = document.getElementById('intimDataHora');
  var dataAtual = elDH && elDH.value ? elDH.value.split('T')[0] : hojeISO();
  ...
  html += '<div class="field"><label>Data e horário</label><input class="input" type="datetime-local" id="intimDataHora" value="' + eb('intimidade', 'data', hojeISO()) + 'T' + eb('intimidade', 'hora', agoraHora()) + '" onchange="renderIntimidade()"></div>';
...
function salvarIntimidade() {
  ...
  var editando = window._editId.intimidade;
  var dataHoraVal = document.getElementById('intimDataHora').value || (hojeISO() + 'T' + agoraHora());
...
function renderAlcool() {
  ...
  html += '</div></div>';
  html += '<div class="field"><label>Data e horário</label><input class="input" type="datetime-local" id="alcoolDataHora" value="' + eb('alcool', 'data', hojeISO()) + 'T' + eb('alcool', 'hora', agoraHora()) + '"></div>';
...
function salvarAlcool() {
  ...
  var editando = window._editId.alcool;
  var dataHoraVal = document.getElementById('alcoolDataHora').value || (hojeISO() + 'T' + agoraHora());
  var partesDH = dataHoraVal.split('T');
  var reg = {
    id: editando ? editando.id : uid(), data: partesDH[0] || hojeISO(),
    hora: partesDH[1] ? partesDH[1].substring(0, 5) : agoraHora(),
