...
function calcFaseCiclo(dataISO, ciclos) {
  ...
  var restante = Math.max(duracao - menstruacaoDias, 1);
  var limMenstruacao = menstruacaoDias;
  var limFolicular = menstruacaoDias + Math.round(restante * 6 / 23);
  var limFertil = menstruacaoDias + Math.round(restante * 11 / 23);
  var limLutea = menstruacaoDias + Math.round(restante * 19 / 23);
  var fase, cor, emoji;
